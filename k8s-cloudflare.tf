...
tunnel: ${cloudflare_zero_trust_tunnel_cloudflared.gcp_tunnel.id}
...
resource "kubernetes_secret" "cloudflared" {
  ...
  data = {
    "credentials.json" = jsonencode({
      ...
      "TunnelID"     = cloudflare_zero_trust_tunnel_cloudflared.gcp_tunnel.id,
      "TunnelName"   = cloudflare_zero_trust_tunnel_cloudflared.gcp_tunnel.name,
